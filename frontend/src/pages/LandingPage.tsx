  ...
  return (
    <main className='flex min-h-svh flex-col items-center justify-center bg-background px-4 py-16 text-center'>
      ...
      <p className='mt-4 max-w-lg text-muted-foreground'>
        Every round hides a secret number. Each wrong guess tells you whether to go higher or lower.
        Your lowest number of guesses is saved to your account, so you always know the record to
        beat.
      </p>
